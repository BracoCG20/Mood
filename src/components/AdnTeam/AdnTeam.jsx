...
// ==========================================
// 🌟 SUB-COMPONENTE DINÁMICO PARA LÍDERES (CON INCLINACIÓN)
// ==========================================
const LeaderCardClipped = ({ member }) => {
  ...
  return (
    <div
      ...
      }} // Arquitectura de sombras para soportar clipPath
    >
      ...
      >
        ...
        <div className='team-card__info-wrapper'>
          {/* Empuje para que no choque con el notch */}
...
// ==========================================
// 🌟 SUB-COMPONENTE DINÁMICO PARA LAS CARDS DEL EQUIPO (CON INCLINACIÓN)
// ==========================================
        ...
        <div className='adn-team__container'>
          ...
          <div className='adn-team__layout'>
            ...
            <div className='adn-team__grid'>
              {/* 🌟 RENDERIZAMOS LÍDERES CON EL NOTCH */}
          ...
          <div className='team-slider'>
            ...
            >
              ...
              >
                {/* 🌟 RENDERIZAMOS EL EQUIPO CON LA NUEVA CARTA NOTCH */}
